...
//SYSIN    DD DUMMY
//SYSLMOD  DD DSN=KICKS.KICKSSYS.V1R5M0.SKIKLOAD(KIKFCTDO),DISP=SHR
//SYSUT1   DD UNIT=SYSDA,SPACE=(CYL,(2,1))
//SYSPRINT DD SYSOUT=*
//ASM      EXEC PGM=IFOX00,
//            PARM='DECK,NOLIST'
...
//SYSLIN   DD DSN=&&OBJSET,DISP=(OLD,DELETE)
//SYSIN    DD DUMMY
//SYSLMOD  DD DSN=KICKS.KICKSSYS.V1R5M0.SKIKLOAD(KIKPCTDO),DISP=SHR
//SYSUT1   DD UNIT=SYSDA,SPACE=(CYL,(2,1))
//SYSPRINT DD SYSOUT=*
//*
//*   DOGE COIN PPT
...
//SYSLIN   DD DSN=&&OBJSET,DISP=(OLD,DELETE)
//SYSIN    DD DUMMY
//SYSLMOD  DD DSN=KICKS.KICKSSYS.V1R5M0.SKIKLOAD(KIKPPTDO),DISP=SHR
//SYSUT1   DD UNIT=SYSDA,SPACE=(CYL,(2,1))
//SYSPRINT DD SYSOUT=*
//*
//ASM      EXEC PGM=IFOX00,
...
//         COND=(0,NE,ASM)
//SYSLIN   DD DSN=&&OBJSET,DISP=(OLD,DELETE)
//SKIKLOAD DD DSN=KICKS.KICKSSYS.V1R5M0.SKIKLOAD,DISP=SHR
//SYSIN    DD DUMMY
//SYSLMOD  DD DSN=KICKS.KICKSSYS.V1R5M0.SKIKLOAD(KIKSITDO),DISP=SHR
//SYSUT1   DD UNIT=SYSDA,SPACE=(CYL,(2,1))
//SYSPRINT DD SYSOUT=*
